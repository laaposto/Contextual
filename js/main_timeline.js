function load_twitter() {
    $.ajax({
        type: 'GET',
        url: 'http://caa.iti.gr:8090/get_twverification?id=' + youtube_parser(video_verify),
            ...
            if (json.hasOwnProperty("message")) {
                ...
                for (var i = 0; i < json.tweets.length; i++) {
                    data.push({
                        ...
                        content: "<img class='tweet_img' src='https://twitter.com/" + json.tweets[i].user.screen_name + "/profile_image?size=normal' height='32' width='32' onerror='imgError1(this);'>",
